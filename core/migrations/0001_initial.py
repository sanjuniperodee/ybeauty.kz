# Generated by Django 2.2 on 2022-07-23 12:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('P', 'Парфюм'), ('UK', 'Уход за кожей'), ('H', 'Уход за волосами'), ('DK', 'Декоративная косметика'), ('PN', 'Подарочный набор'), ('DD', 'Для дома')], max_length=2)),
                ('subcategory', models.CharField(choices=[('Man', 'man'), ('Wom', 'woman'), ('Nab', 'nabor')], default='Man', max_length=3)),
